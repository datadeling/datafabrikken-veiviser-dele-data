  ...
  return (
    <Primitives.Wizard>
        <IntroMain>
            ...
            <SC.BetaInfoBox>
                <Primitives.Heading.H3>Veilederen er under utvikling</Primitives.Heading.H3>
                <Primitives.Paragraphs.P>
                    Vi jobber med å kontinuerlig forbedre veilederen og ønsker å lære hvordan den kan gi verdi til deg som bruker. Hvis du oppdager feil, unøyaktigheter eller har andre innspill kan du melde inn dette til datafabrikken@norge.no eller stille spørsmål i Datalandsbyen.
                </Primitives.Paragraphs.P>
            </SC.BetaInfoBox>
